<div id="content-single" class="content group">
    <div class="hentry hentry-post blog-big group ">
        ...
        <div class="meta group">
            <p class="author"><span>by <a href="blog-big-image.html" title="Posts by Nicola Mustone" rel="author">Nicola Mustone</a></span>
            </p>
            <p class="categories"><span>In: <a href="blog-big-image.html" title="View all posts in Design"
                                               rel="category tag">Design</a>, <a href="blog-big-image.html"
                                                                                 title="View all posts in Happyness"
                                                                                 rel="category tag">Happyness</a>, <a
                            href="blog-big-image.html" title="View all posts in WordPress"
                            rel="category tag">WordPress</a></span></p>
            <p class="comments"><span><a href="#comments"
                                         title="Comment on This is the title of the first article. Enjoy it.">2 comments</a></span>
            </p>
        </div>
        <!-- post content -->
        <div class="the-content single group">
            ...
            <p>Duis nulla purus, malesuada in gravida sed, viverra at elit. Praesent nec purus sem, non imperdiet quam.
                Praesent tincidunt tortor eu libero scelerisque quis consequat justo elementum. Maecenas aliquet
            ...
            <p>Cras a tellus eu justo lobortis tristique et nec mauris. Etiam tincidunt tellus ut odio elementum
                adipiscing. Maecenas cursus dolor sit amet leo elementum ut semper velit lobortis. Pellentesque
                posue</p>
            <div class="socials">
