...
{!! Form::open(['url' => (isset($article->id)) ? route('admin.articles.update', $article->alias) : route('admin.articles.store'),'class'=>'contact-form','method'=>'POST','enctype'=>'multipart/form-data']) !!}
